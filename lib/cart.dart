    ...
    return SafeArea(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Text(
                      'Cart',
                      style: TextStyle(color: Colors.pink, fontSize: 20,fontFamily: 'DMSerifDisplay'),
                    ),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: TextButton(
                  ...
                  child: const Padding(
                    ...
                    child: Text(
                      'View Wishlist (3)', 
                      style: TextStyle(color: Colors.pink, fontFamily: 'DMSerifDisplay', fontSize: 15),
                    ),
                  ),
                ),
              ),
        ...
        SingleChildScrollView(
          child: SizedBox(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: const Color.fromARGB(255, 255, 255, 255)), // Optional border
            ),
            child: Column(
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            icon: const Icon(Icons.arrow_forward, color: Colors.green), // Arrow button
            onPressed: () {
