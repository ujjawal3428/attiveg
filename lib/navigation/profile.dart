...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      case 0:
        // Toggle popup visibility if needed, but currently, this might not be necessary.
        break;
      case 1:
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Flexible(child: SizedBox(width: 292,)),
  ...
  child: Container(
    ...
    child: Row(
      ...
      children: [
        ...
        SizedBox(width: 10,),
        Text('Help&FAQs', style: TextStyle(fontFamily: 'DMSerifDisplay',),),
        Flexible(child: SizedBox(width: 265,)),
        InkWell(
          onTap: (){
              Navigator.push(
            context, MaterialPageRoute(builder: (context) => Helpandfaqs()));
          },
          child: Image.asset(
  ...
  child: Container(
    ...
    child: Row(
      ...
      children: [
        ...
        SizedBox(width: 10,),
        Text('Manage Address', style: TextStyle(fontFamily: 'DMSerifDisplay',),),
        Flexible(child: SizedBox(width: 229,)),
        InkWell(
          onTap: (){
              Navigator.push(
  ...
  child: Container(
    ...
    child: Row(
      children: [
        ...
        SizedBox(width: 10,),
        Text('Log Out',style: TextStyle(fontFamily: 'DMSerifDisplay',),),
        Flexible(child: SizedBox(width: 285,)),
        InkWell(
          onTap: (){
             showDialog(
              context: context,
