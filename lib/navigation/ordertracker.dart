...
class _OrdertrackerState extends State<Ordertracker> {
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text('Expected Delivery:', style: TextStyle(fontSize: 12, color: Colors.grey)),
                ),
             SizedBox(height: 6,),
                Padding(
                  padding: const EdgeInsets.only(left: 10.0),
  ...
  child: LayoutBuilder(
    builder: (context, constraints) {
      ...
      final dashCount = (width / 10).floor(); // Adjust dash count based on available width
        ...
        children: List.generate(dashCount, (index) {
          return Row(
            children: [
              ...
              if (index < dashCount - 1) SizedBox(width: 5), // Space between dashes
            ],
          );
        }),
      );
                ...
                Padding(
                  ...
                  child: Flexible(
                    child: Row(
                      children: [
                        Text('Tracking number: ', style: TextStyle( fontWeight: FontWeight.bold,fontSize: 16)),
                        Text(
                          'FY8247924294',
