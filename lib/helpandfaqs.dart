    ...
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
                                        ...
                                        child:const  Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              CircleAvatar(
                                                backgroundColor:  Color.fromARGB(255, 246, 170, 195),
                                                child: Icon(
                                                  size: 20,
                                        ...
                                        child: const Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              CircleAvatar(
                                                backgroundColor: Color.fromARGB(255, 209, 248, 246),
                                                child: Icon(
                                                  size: 20,
                                                  Icons.discount, 
                                                  color: Colors.black, 
                                        ...
                                        child: const Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              CircleAvatar(
                                                backgroundColor:  Color.fromARGB(169, 0, 220, 161),
                                                child:  Icon(
                                                  size: 20,
                                                  Icons.payments, 
                                                  color: Colors.black, 
                                        ...
                                        child: const Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              CircleAvatar(
                                                backgroundColor: Color.fromARGB(167, 235, 186, 64),
                                                child: Icon(
                                                  size: 20,
          ...
          Padding(
          padding: const EdgeInsets.only(top: 5.0, left: 16, right: 16, bottom: 0,),
          child: Container(
            height: 270,
            decoration: BoxDecoration(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 0.0, right: 10, left: 10, bottom: 15),
                        child: IconButton(
