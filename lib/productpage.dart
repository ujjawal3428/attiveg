  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage('assets/cetaphilproduct@4x.png'), 
              fit: BoxFit.cover, 
            ),
          ),
        ),
                      ...
                      children: [
                        InkWell(
                          ...
                          child: SizedBox(
                            width: 30,
                            height: 30,
                            child: Image.asset('assets/productheart.png'),
                          ),
                        ),
                        ...
                        InkWell(
                          ...
                          child: SizedBox(
                            width: 30,
                            height: 30,
                            child: Image.asset('assets/productshare.png'),
                          ),
                        ),
                      ],
                    ),
                ...
                SizedBox(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      TextButton(
                        child: const Text('check availability', style: TextStyle( fontFamily: 'DMSerifDisplay',),),
                        onPressed: () {
                          // Handle button press
                        },
                      ),
                    ...
                    Expanded(
                      child: RichText(
                        text: const TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: "This is a lorem gypsum hydrate of the eraculer circumstances where a person with high blood pressure would not handle a cup of tea for some milk.",
          ...
          const SizedBox(height: 20),
            ElevatedButton(
              ...
              child: const Text("Read More", style: TextStyle( fontFamily: 'DMSerifDisplay',),),
            ),
      ...
      children: [
        ...
        const SizedBox(height: 20), // Margin below the divider
        ...
        const SizedBox(height: 10), // Space below the grey divider
        ...
        Padding(
         padding: const EdgeInsets.all(10),
          child: Row(
            ...
            children: [
              const Icon(
                Icons.business, // Replace with the desired blue icon
                color: Colors.blue,
              ),
              const SizedBox(width: 8),
              const Text(
        ...
        const SizedBox(height: 5), // Space below the country row
...
//NEW ARRIVALS SECTION
  ...
  return Container(
    margin: const EdgeInsets.only(left: 8,right: 8, top: 0, bottom: 15),  // Reduced margin
            ...
            const Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Product Name',
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12),  // Added fontSize
                  ),
                  Row(
                    children: [
                      Icon(Icons.star, color: Colors.amber, size: 14),  // Reduced from 16
                      SizedBox(width: 2),  // Reduced from 4
                      Text(
                        '4.5',
                        style: TextStyle(color: Colors.grey, fontSize: 10),  // Reduced from 12
                      ),
                    ],
                  ),
                ],
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    const Text(
                      '₹999',
                      style: TextStyle(color: Colors.pink, fontFamily: 'DMSerifDisplay', fontSize: 16),  // Reduced from 19
                    ),
                    const SizedBox(width: 6),  // Reduced from 10
                    const Text(
                      '₹1089.00',
                      style: TextStyle(color: Colors.grey, fontFamily: 'DMSerifDisplay', fontSize: 7, decoration: TextDecoration.lineThrough, decorationThickness: 1.5),  // Reduced from 8.4
                    ),
                    const SizedBox(width: 6),  // Reduced from 10
                    Container(
